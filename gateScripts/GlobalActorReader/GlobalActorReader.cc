...
int GlobalActorReader::GetParentID() const {return ParentID.GetValue();}

double GlobalActorReader::GetInteractionTime() const {return InteractionTime.GetValue();}

double GlobalActorReader::GetLocalTime() const {return LocalTime.GetValue();}

double GlobalActorReader::GetGlobalTime() const {return GlobalTime.GetValue();}

double GlobalActorReader::GetProperTime() const {return ProperTime.GetValue();}
